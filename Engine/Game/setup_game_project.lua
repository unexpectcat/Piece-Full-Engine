project "myGame"
   ...
   targetdir ("$(SolutionDir)Engine/Game/Build/" .. OutputDir .. "/%{prj.name}")
   objdir ("$(SolutionDir)Engine/Game/Build/Intermediates/" .. OutputDir .. "/%{prj.name}")
   ...
   filter "configurations:Release"
       ...
       symbols "On"
       linkoptions { "/NODEFAULTLIB:MSVCRT.lib" }
       debugenvs { "PATH=%PATH%;$(SolutionDir)\\Engine\\Binaries\\Release" }
   ...
   filter "configurations:Dist"
       ...
       symbols "Off"
       linkoptions { "/NODEFAULTLIB:MSVCRT.lib" }
       debugenvs { "PATH=%PATH%;$(SolutionDir)\\Engine\\Binaries\\Dist" }